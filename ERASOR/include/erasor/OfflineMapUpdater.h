...
namespace erasor {
    ...
    private:
        ...
        double trans_diff_thr_; // unit: m
        double rot_diff_thr_;   // unit: deg
        ...
        ros::Publisher pub_path_of_all_nodes_;
